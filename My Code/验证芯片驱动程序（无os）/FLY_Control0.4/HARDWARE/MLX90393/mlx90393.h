...
//extern float gain_multipliers[8];
//extern float base_xy_sens_hc0;
//extern float base_z_sens_hc0;
//extern float base_xy_sens_hc0xc;
//extern float base_z_sens_hc0xc;

extern uint8_t posture[10];
