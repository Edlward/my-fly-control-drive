...
#define RT_USING_DFS
#define RT_USING_DFS_ELMFAT          //使用fatfs文件系统
#define RT_DFS_ELM_MAX_SECTOR_SIZE 256
#define RT_DFS_ELM_DRIVES          1  //文件系统的底层设备个数
...
//#define RT_DFS_ELM_CODE_PAGE 936   //对中文命名的支持
