...
//		LOG_RAW("accel_ref[%d]:%f \t accel_ref[%d]:%f  \n",i ,accel_ref[i * 2][i],i,accel_ref[i * 2 + 1][i]);
		LOG_RAW("accel_offs[%d]:%f \n",i ,accel_offs[i]);
	}
...
{
	int res;
	struct calibration_s accel_scale;
